...
import com.bugtracker.validation.UniqueEmail;
...
public class UserRegister {
    ...
    @Size(min = 3, max = 30, message = "Username must be between 3 and 30 characters", groups = OnCreate.class)
    @Pattern(regexp = "^[a-zA-Z0-9_.-]+$", message = "Username can only contain letters, numbers, dots, dashes and underscores", groups = OnCreate.class)
